...
export class WithdrawService {
  ...
  updateUserBalance(userData:any,balance:number,amount:number,transactionArray:any) {
    ...
    transactionArray.push({transactionType:"Withdraw",amountUpdated:amount,timestamp:new Date()});
  ...
  updateAdmin(adminData: any, amount: number, useraccountNumber: string | null | undefined) {
    adminData[0].transactions.push({senderAccount:useraccountNumber,receiverAccount:useraccountNumber,type:"Withdraw",amountInvolved:amount});
